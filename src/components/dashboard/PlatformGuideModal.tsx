    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="bg-white dark:bg-[#08262b] border border-teal-900/20 dark:border-teal-500/30 rounded-3xl max-w-lg w-full shadow-2xl overflow-hidden relative animate-vague-in flex flex-col max-h-[90dvh]">
        ...
        <div className="px-4 sm:px-6 pt-5 sm:pt-6 pb-3.5 sm:pb-4 border-b border-line dark:border-teal-900/80 flex items-center justify-between flex-shrink-0">
          ...
          <button
            onClick={onClose}
            className="text-ink-soft dark:text-teal-400 hover:text-ink dark:hover:text-white p-1 rounded-xl hover:bg-surface-alt dark:hover:bg-teal-950 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-4 sm:p-6 overflow-y-auto flex-1 space-y-4">
          <p className="text-xs font-semibold text-ast-primary dark:text-teal-300">
            {current.subtitle}
          </p>
          {current.content}
        </div>
        ...
        <div className="px-4 sm:px-6 py-3 sm:py-4 bg-surface-alt/60 dark:bg-[#04191c] border-t border-line dark:border-teal-900/80 flex items-center justify-between flex-shrink-0">
              ...
              <span
                ...
                className={`h-1.5 rounded-full transition-all duration-300 ${
                  i === activeStep
                    ...
                    : "w-1.5 bg-line dark:bg-teal-900"
                }`}
              />
            ))}
          </div>
          ...
          <div className="flex items-center gap-2">
            {activeStep > 0 && (
              <button
                ...
                className="px-3 py-2 rounded-xl text-xs font-semibold text-ink-soft dark:text-teal-300 hover:bg-surface-alt dark:hover:bg-teal-950 transition-colors flex items-center gap-1"
              >
