              ...
              <form onSubmit={handleSubmit} className="space-y-6 pt-6 border-t border-line dark:border-teal-900/80">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="text"
                        required
                        placeholder="e.g. Yasmine Ben Salem"
                        value={form.name}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="email"
                        required
                        placeholder="yasmine.bensalem@esprit.tn"
                        value={form.email}
                ...
                <div>
                  ...
                  <textarea
                    required
                    rows={4}
                    placeholder="Tell us what drives you, projects you have built, and why you want to join Asteria Club Esprit..."
                ...
                <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="flex items-center gap-2 text-xs text-ink-soft dark:text-teal-200/70 font-body">
                    ...
                    <span>Your data is stored securely in our cloud database.</span>
                  </div>
                  ...
                  >
                    {loading ? "Submitting Dossier..." : "Submit Recruitment Dossier ★"}
