      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md animate-vague-in px-4">
        <Card className="p-6 sm:p-8 bg-surface shadow-md space-y-6">
          ...
          <div className="pt-4 border-t border-line space-y-2.5">
            <div className="flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-wider text-ink-faint font-display">
              ...
              {quickDemoAccounts.map((acc) => {
                ...
                return (
                  <button
                    ...
                    className="p-2.5 rounded-xl border border-line bg-surface-alt hover:bg-teal-50 hover:border-teal-400/60 text-left transition-all group"
                  >
                    <div className="flex items-center gap-1.5">
                      <Icon className="w-3 h-3 text-teal-900" />
                      <span className="font-bold text-[11px] text-ink truncate group-hover:text-teal-900">
                        {acc.title}
                      </span>
                    </div>
